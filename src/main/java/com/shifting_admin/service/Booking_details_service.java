...
public interface Booking_details_service {
	...
	List<Booking_details> getallbookingsongivendate(Date date1);
	...
	void generatepdfbookingsbasedontwodates(Date fromdate, Date todate, List<Booking_details> list);



	void generatebookingsbasedonbetweendatesandlocation(List<Booking_details> list, Date date1, Date date2,
			String location);
